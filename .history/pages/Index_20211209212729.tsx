    ...
    return (
       ...
       <div >
           <div className="inset-0 items-center justify-center p-12 font-mono font-semibold text-white duration-300 ">
               ...
               <button  className="px-4 py-2 my-10 text-xl font-normal text-white bg-gray-400 rounded sm:text-2xl md:text-2xl lg:text-3xl hover:bg-gray-600" onClick={()=>window.open("mailto:vanshchaudhary77@gmail.com?subject=Query for blogOVERFLOW") }>Mail Blog</button>
