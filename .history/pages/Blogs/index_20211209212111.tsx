...
export const getStaticProps = async () => {
    const res = await fetch(`https://crudcrud.com/api/521aaa9043ec4d41ac326ff9cab386f0/iblog/`);
   ...
   const deleteBlog = async (blogId:string) =>{
    const response = await fetch(`https://crudcrud.com/api/521aaa9043ec4d41ac326ff9cab386f0/iblog/${blogId}`, {
        method: 'DELETE', 
        headers: {
