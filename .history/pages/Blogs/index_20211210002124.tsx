...
export const getStaticProps = async () => {
    const res = await fetch(`https://crudcrud.com/api/59c214e44e174da79c25d253db94bd58/imt/`);
   ...
   const deleteBlog = async (blogId:string) =>{
    const response = await fetch(`https://crudcrud.com/api/59c214e44e174da79c25d253db94bd58/imt/${blogId}`, {
        method: 'DELETE', 
        headers: {
